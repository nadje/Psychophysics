...
for subject = 1:length(subjects)
 ...
 tbd_pn=   sum(results_nomiss_pn(:,4)==3)+sum(results_nomiss_pn(:,4)==5)
    ...
    % %% SAVE
    cd(analysis_path)
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_AS_relative results_forfit_as']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_PS_relative results_forfit_ps']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_AN_relative results_forfit_an']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_PN_relative results_forfit_pn']);
%     % save results_nomiss for each condition (with timing info)
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_AS_Raw_relative results_nomiss_as']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_PS_Raw_relative results_nomiss_ps']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_AN_Raw_relative results_nomiss_an']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_Discrimination_PN_Raw_relative results_nomiss_pn']);
%     % save percent louder data for comparisons with reznik
%     
%     eval(['save ' num2str(subjects(subject),'%02d') '_reznik_comp_as reznik_comp_as']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_reznik_comp_ps reznik_comp_ps']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_reznik_comp_an reznik_comp_an']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_reznik_comp_pn reznik_comp_pn']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_percent1ndLouder_AS percent1ndLouder_AS']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_percent1ndLouder_PS percent1ndLouder_PS']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_percent1ndLouder_AN percent1ndLouder_AN']);
%     eval(['save ' num2str(subjects(subject),'%02d') '_percent1ndLouder_PN percent1ndLouder_PN']);
